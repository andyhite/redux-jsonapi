...
var handleResponse = function () {
  var _ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee(response) {
    var _ref2, data, _ref2$included, included, _ref2$meta, meta, headers;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            headers = [].concat((0, _toConsumableArray3.default)(response.headers)).reduce(function (result, item) {
